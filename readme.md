...
Este repositorio es para aprender Git bien hecho.
## Temas a aprender
- Aqui vamos a generar un pedillo. "AQUI" Estados de archivos conflictos
- Commits
- Conflictos
...
## "AQUI TAMBIEN" Feature: README mejorado
